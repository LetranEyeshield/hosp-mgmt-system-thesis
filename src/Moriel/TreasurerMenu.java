...
public class TreasurerMenu extends JFrame implements ActionListener, MenuListener{
	...
	public void setBackground(){
		...
		background = new JLabel();
		 background = new JLabel(new ImageIcon("res/treasurer.png"));
	...
	public void setMenuButts(){
		...
		pharmacy = new JButton("PHARMACY BILLING");
		pharmacy.setBounds(475,400,150,30);
