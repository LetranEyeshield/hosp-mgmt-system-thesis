...
public class DataEncoderMenu extends JFrame implements ActionListener, MenuListener{
	...
	public void setBackground(){
		...
		background = new JLabel();
		 background = new JLabel(new ImageIcon("res/encoder.png"));
